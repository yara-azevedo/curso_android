...
public class AFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       textView = view.findViewById(R.id.textViewA); //pra manipular os componentes precisa criar uma view e usar ela pra instanciar
       textView.setText("AAAAAAAAAAAAAB");
       return view;
    }
}